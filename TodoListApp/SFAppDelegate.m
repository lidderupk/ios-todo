...
{
    [SFTodoModel registerSubclass];
    
    [Parse setApplicationId:@"QIeaXkdZEQnYJslCs00zQ3qMn8zwfK1SWlLsnMu9"
                  clientKey:@"IOfLu8ISOgF1G695w9kzfdEGiPlL97jhccSqKhjn"];
    ...
    SFTodoTableViewController *todoViewController = [[SFTodoTableViewController alloc]init];
